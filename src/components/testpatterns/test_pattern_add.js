...
//        }
       ...
       const k = postData(`${process.env.NEXT_PUBLIC_HOST_URL}/api/patterns`,formData);
    ...
    <div>
        ...
        <div className="input-type px-2 py-2">
            <input type="file" name="logo"  onChange={handleImageUpload} className="w-full px-5 py-3 focus:outline-none rounded-md focus:border-gray-500 text-center" placeholder="Logo" required/>
        ...
        <div className="input-type px-2 py-2">
            <input type="number" name="noofques"  value={noofques} onChange={(e)=>{setques(e.target.value)}} className="border w-full px-5 py-3 focus:border-gray-500 rounded-md" placeholder="No of Questions" required/>
        </div>
        ...
        <div className="input-type px-2 py-2">
            <input type="number" name="duration"  value={duration} onChange={(e)=>{setduration(e.target.value)}} className="border w-full px-5 py-3 focus:border-gray-500 rounded-md" placeholder="Enter Duration in Minutes" required/>
        </div>
